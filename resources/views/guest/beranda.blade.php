...
<div class="container">
    <div class="row space hideme">
        ...
        <div class="col-6 p-5 align-self-center">
            ...
            <p class="justify pt-3 fw-normal">Desa Kadipiro terletak di Kecamatan Sambirejo, Kabupaten Sragen, Provinsi Jawa Tengah. Desa Kadipiro memiliki 3 wilayah kebayanan, yaitu : Kebayanan Kadipiro, Kebayanan Geneng, dan Kebayanan Ledok. Dengan luas 3500 m² kondisi geografis Desa Kadipiro berada pada Lereng Gunung Lawu berketinggian +- 200 MDPL. Jumlah penduduk +-4500 jiwa dengan mayoritas sebagai petani/pekebun.</p>
        </div>
    </div>
    <div class="row space hideme">
        <div class="col-6 p-5">
